...
class _ListagemDePacientesState extends State<ListagemDePacientes> {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return GestureDetector(
                        ...
                        onTap: () {
                          // _mostrarDetalhesDoPaciente(
                          //     paciente: pacientes[index], user: widget.user);
                        },
                      );
                    });
              }
  ...
  // void _mostrarDetalhesDoPaciente({Paciente paciente, User user}) {
  //   ScreeanArguments screeanArguments =
  //       new ScreeanArguments(user: user, paciente: paciente);
  //   Navigator.of(context)
  //       .pushNamed('InfoPaciente', arguments: screeanArguments);
  // }
}
