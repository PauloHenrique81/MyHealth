...
class ListagemVacinasGestante extends StatefulWidget {
  final User user;
  Vacina vacinas = Vacina();
  List<VacinaUser> listVacinaUser;
  ListagemVacinasGestante({this.user, this.vacinas, this.listVacinaUser});

  @override
  _ListagemVacinasGestanteState createState() =>
      _ListagemVacinasGestanteState();
}

class _ListagemVacinasGestanteState extends State<ListagemVacinasGestante> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Vacinas para Gestante"),
