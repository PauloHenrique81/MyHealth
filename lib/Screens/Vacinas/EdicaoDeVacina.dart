...
class EdicaoDeVacina extends StatefulWidget {
  ...
  final TiposDeVacinas tiposDeVacinas;
  final User user;

  EdicaoDeVacina(
      {this.user, this.tiposDeVacinas, String codigoDaVacina, String data}) {
    vacinaUser = new VacinaUser(codigoDaVacina, user.uid, data);
  }
